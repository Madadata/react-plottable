export const createSingle2DPlotLabels = (generic2DPlotConfig) => {
...
export const createDouble2DPlotLabels = (generic2DPlotConfigArray) => {
...
export const createMultiple2DPlotLabels = (generic2DPlotConfigArray) => {
