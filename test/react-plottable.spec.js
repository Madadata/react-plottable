...
/***/ function(module, exports, __webpack_require__) {
	...
	describe('Scales Tests:', function () {
	  describe('Func: createScale', function () {

	    it('should return if the inputs are valid', function () {
	      var linear = (0, _scales.createScale)('linear');
	      var category = (0, _scales.createScale)('category');
	      var color = (0, _scales.createScale)('color');
	      var colorRange = ['rgb(14, 88, 65)', 'rgb(140, 237, 207)'];
	      var interpolatedColor = (0, _scales.createScale)('interpolatedcolor', colorRange);
	      var expectedIColor = new Plottable.Scales.InterpolatedColor();
	      expectedIColor.range();
	      (0, _expect2.default)(linear).toEqual(new Plottable.Scales.Linear());
	      (0, _expect2.default)(category).toEqual(new Plottable.Scales.Category());
	      (0, _expect2.default)(color).toEqual(new Plottable.Scales.Color());
	      (0, _expect2.default)(interpolatedColor).toEqual(interpolatedColor);
	    });

	    it('should throw error if no input is given', function () {
	      var createNoneScale = function createNoneScale() {
	        (0, _scales.createScale)();
	      };
	      (0, _expect2.default)(createNoneScale).toThrow();
	    });

	    it('should throw error if range is not given in case of interpolatedcolor', function () {
	      var createInterpolatedColorWithoutRange = function createInterpolatedColorWithoutRange() {
	        (0, _scales.createScale)('interpolatedcolor');
	      };
	      (0, _expect2.default)(createInterpolatedColorWithoutRange).toThrow();
	    });

	    it('should throw error the scale type is not supported', function () {
	      var createHelloScale = function createHelloScale() {
	        (0, _scales.createScale)('hello');
	      };
	      (0, _expect2.default)(createHelloScale).toThrow();
	    });
	  });

	  describe('Func: createScales', function () {
	    it('should return scales as required', function () {
	      var _createScales = (0, _scales.createScales)('time', 'linear');

	      var xScale = _createScales.xScale;
	      var yScale = _createScales.yScale;

	      (0, _expect2.default)(xScale).toEqual(new Plottable.Scales.Time());
	      (0, _expect2.default)(yScale).toEqual(new Plottable.Scales.Linear());
	    });
	  });
	});
...
/***/ function(module, exports) {
	...
	exports.createCategoryScale = createCategoryScale;
	exports.createColorScale = createColorScale;
	exports.createTimeScale = createTimeScale;
	exports.createInterpolatedColorScale = createInterpolatedColorScale;
	...
	function createScales(xType, yType, xRange, yRange) {
	  var xScale = createScale(xType, xRange);
	  var yScale = createScale(yType, yRange);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SpyUtils = __webpack_require__(29);

	var _assert = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tmatch = __webpack_require__(21);
	...
	var _TestUtils = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(22), __webpack_require__(23).Buffer))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectInspect = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _objectKeys = __webpack_require__(31);
